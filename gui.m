...
% Last Modified by GUIDE v2.5 09-May-2018 13:06:28
...
%input_image='C:\Users\Muneeb Ahmad\Desktop\AI\project downloads\mathworks\face_recognition2\images\salman11.jpg';
...
if(handles.faceDetect==1)
    input_image=face_detect(handles.input_image);

input_image=preprocessing(handles.rows,handles.cols,input_image);
else
    input_image=preprocessing(handles.rows,handles.cols,handles.input_image2);
end
%input_image=imread(input_image);
image=input_image;
